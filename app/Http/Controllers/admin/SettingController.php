          ...
          foreach($_POST as $key => $value){
		   ...
		   if($request->hasFile('logo')) {
            ...
            if($request->hasFile('logo2')) {
                $storagepath2 = $request->file('logo2')->store('public/logo');
                $fileName2 = basename($storagepath2);
                $logo2['name']='logo2';
                $logo2['value'] = $fileName2;

                //if file chnage then delete old one
                $oldFile2 = $request->get('oldLogo2','');
                if( $oldFile2 != ''){
                    $file_path2 = "public/logo/".$oldFile2;
                    Storage::delete($file_path2);
                }
            }
            else{
            	$logo['name']='logo2';
                $logo['value'] = $request->get('oldLogo2','');
            }
